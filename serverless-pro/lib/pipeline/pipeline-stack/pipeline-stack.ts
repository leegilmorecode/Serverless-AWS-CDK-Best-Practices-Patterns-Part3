  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const pipeline: pipelines.CodePipeline = new pipelines.CodePipeline(
      ...
      'PipelineStack',
      {
        ...
        selfMutation: true,
        codeBuildDefaults: {
          cache: codeBuild.Cache.bucket(new s3.Bucket(this, 'CodeBuildCache')),
        },
        assetPublishingCodeBuildDefaults: {
          cache: codeBuild.Cache.bucket(new s3.Bucket(this, 'AssetCache')),
        },
        pipelineName: 'serverless-pro-pipeline',
        synth: new pipelines.CodeBuildStep('Synth', {
          cache: codeBuild.Cache.bucket(new s3.Bucket(this, 'PipeLineCache')),
          input: pipelines.CodePipelineSource.gitHub(
            'leegilmorecode/serverless-aws-cdk-best-practices-patterns-part3',
            'main'
          ),
